...
function main() {
    ...
    if (!strcmp($_GET['instructor'], 'gpcorser')) {
        ...
        echo $_GET['day'] ? ' - Day(s): ' . strtoupper($_GET['day']) : "";
        echo '</h2>';
    }
    ...
    if (!($obj->courses == null)) {
        ...
        foreach ($obj->courses as $course) {
            ...
            if($day == ""){
                ...
                if ($course->meetingTimes[0]->days == "M" && $i == 0) {
                    #run the print function ie make a function for below
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "MW" && $i == 1){
                    #run the print function
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "T" && $i == 2){
                    #run the print function
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "TTR" && $i == 3){
                    #run the print function
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "W" && $i == 4){
                    #run the print function
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "TR" && $i == 5){
                    #run the print function
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "F" && $i == 6){
                    #run the print function
                    print_table_contents($course);
                } elseif($course->meetingTimes[0]->days == "" && $i == 7){
                    #run the print function
                    print_table_contents($course);
                }
            } elseif($course->meetingTimes[0]->days == $day && $i == 8) {
                print_table_contents($course);
            }
...
function print_table_contents($course){
